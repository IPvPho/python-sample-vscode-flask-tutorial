[![Build Status](https://dev.azure.com/chrirandevops/AZ_DevOps_Test/_apis/build/status/IPvPho.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/chrirandevops/AZ_DevOps_Test/_build/latest?definitionId=1&branchName=master)
